...
<section class="accounts">
   ...
   <div class="box">
      ...
      <div class="flex-btn">
         <a href="admin_accounts.php?delete=<?= $fetch_accounts['id']; ?>" onclick="return confirm('Hapus akun?')" class="delete-btn">delete</a>
         <?php
   ...
   <?php
         ...
         echo '<p class="empty">akun tidak ditemukan!</p>';
      }
   ?>
