...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="hapus barang" onclick="return confirm('hapus dari wishlist?');" class="delete-btn" name="delete">
   </form>
   <?php
      }
   }else{
   ...
   <div class="wishlist-total">
      ...
      <a href="wishlist.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'enabled'; ?>" onclick="return confirm('hapus semua barang dari wishlist?');">Hapus semua barang</a>
   </div>
