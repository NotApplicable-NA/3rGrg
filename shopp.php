...
<head>
   ...
   <title>Sparepart 3R Garage</title>
...
<section class="category">
   ...
   <h1 class="heading">Belanja Sesuai Kebutuhan Anda</h1>

   <div class="swiper category-slider">

   <div class="swiper-wrapper">

   <a href="category.php?category=Oli" class="swiper-slide slide">
      <h3>Oli</h3>
   </a>
   ...
   <a href="category.php?category=busi" class="swiper-slide slide">
      <h3>Busi</h3>
   </a>
