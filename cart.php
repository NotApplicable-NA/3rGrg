...
<section class="products shopping-cart">
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'enabled'; ?>" onclick="return confirm('Hapus dari keranjang?');">Hapus semua barang?</a>
      <a href="checkout.php" class="btn <?= ($grand_total > 1)?'':'enabled'; ?>">Lanjutkan ke pembayaran.</a>
   </div>
